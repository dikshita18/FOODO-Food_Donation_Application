                  ...
                  {!isLoaded ? <div>Loading....</div> :
                    <div>
                      {data.map((item)=>{
                        ...
                        <Link to={'update/'+item.id} className="btn btn-dark btn-md btn-block btn-space">Update Data</Link>
...
<button type="submit" className="btn btn-dark btn-md btn-block btn-space" align="center" 
onClick={ () => {this.acceptData("Accepted")} }>{ text }</button> 
                    ...
                    <div>
                      {data.map((item)=>{
                        ...
                        centered>
                          ...
                          <Modal.Body>
                            <p>You have accepted the donation. Your Donation ID is <b>{item.id}</b>. <br />
                            Once the donation process has been complete please notify us by entering this id in the notify tab. <br />
                            Thank you!</p>
                          </Modal.Body>
                          <Modal.Footer>
                        ...
                        <button type="submit" className="btn btn-dark btn-md btn-block" align="center" 
                        onClick={() => {this.handleModalShowHide3(item.id); this.deleteData(item.id)}}>Accept Donation</button> <br /> 
                        < hr/>
                        </p>
